...
const Navbar = () => {
  ...
  const socileLinks = (
    <div className="flex gap-3 flex-1 justify-end">
      <Link to='https://github.com/saiyedimtiaj' target="_blank" ><img className="transition hover:-translate-y-1 w-6 h-6 bg-white rounded-full" src={github} alt="" /></Link>
      <Link to='https://www.linkedin.com/in/saiyed-mohammad-imtiaj-79217a2a4/' target="_blank" ><img className="transition hover:-translate-y-1 w-6 h-6" src={linkdin} alt="" /></Link>
      <Link to='https://web.facebook.com/saiyed.imtiaz' target="_blank" ><img className="transition hover:-translate-y-1 w-6 h-6" src={faceBook} alt="" /></Link>
    </div>
  );

  return (
    <>
      <div className="flex px-3 justify-around items-center py-4">
